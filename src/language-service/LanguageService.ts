import { ExpressionContext,Select_statementContext,Selected_listContext } from "../ANTLR/OracleStatementParser";
...
function checkSemanticRules(ast: ExpressionContext): ITodoLangError[] {
    ...
    ast.children.forEach(node => {
        if (node instanceof Select_statementContext) {
            errors.push({
                ...
                message: `Todo ${999} already defined`,
